...
#'
#' Given 1 to 5 VisionZero cities (Boston, NYC, Boulder, Denver or Richmond), this function creates a point graph of vehicular fatalities throughout the years (from 2008-2023) normalized to the population size of the city for the user-given cities. This function uses vehicular fatality and population data aggregated for this cities in the `vz_data_2023` data set
#'
...
#'
#' @return A graph in the `plots` window looking at the percentage of vehicular fatalities based on population size across the years 2008-2023 (year range dependent on the available data for the user-given cities).
#'
#' @examples
